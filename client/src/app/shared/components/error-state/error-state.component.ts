  ...
  template: `
    <section class="glass-panel glass-depth-floating mx-auto grid max-w-[var(--ui-container-md)] justify-items-center gap-md rounded-md p-xl text-center">
      ...
      <div class="flex flex-wrap justify-center gap-sm">
        ...
        @if (homeLink(); as home) {
          <a class="glass-panel glass-depth-raised inline-flex min-h-control-md items-center rounded-md px-md py-xs type-label-md text-text-primary interactive-transition hover:shadow-glass-floating focus-visible:focus-ring" [routerLink]="home">
            Return home
          </a>
        }

        @if (supportLink(); as support) {
          <a class="glass-panel glass-depth-raised inline-flex min-h-control-md items-center rounded-md px-md py-xs type-label-md text-text-primary interactive-transition hover:shadow-glass-floating focus-visible:focus-ring" [href]="support">
            Contact support
          </a>
        }
      </div>
